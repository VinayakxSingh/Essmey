    ...
    >
      <div className="container-custom flex items-center justify-between">
        ...
        <Link to="/" className="text-3xl font-serif font-bold">
          <span className="text-black">ESSMEY</span>
        </Link>
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link
            to="/cart"
            className="relative p-1 rounded-full hover:bg-neutral-100"
          >
            <ShoppingBagIcon className="h-5 w-5 text-black" />
            {cartCount > 0 && (
              <span className="absolute -top-1 -right-1 flex items-center justify-center h-4 w-4 text-xs bg-black text-white rounded-full">
                {cartCount}
              </span>
            )}
          </Link>
        ...
        <div className="md:hidden absolute top-full left-0 w-full bg-white shadow-md">
          <nav className="container-custom py-4 flex flex-col space-y-3">
            ...
            <details className="group">
              <summary className="nav-link py-2 list-none flex justify-between cursor-pointer">
                Collections
                <svg
                  className="h-4 w-4"
                  viewBox="0 0 20 20"
